...
$(function () {
    ...
    /* Fixed height for blocks (width <576px) */
    if (window.innerWidth < 576) {
        $(".first-sec .info-block").css({"height": "" + (window.innerHeight * 0.4) + "px"});
        $(".product-item").css({"height": "" + (window.innerHeight - 79) + "px"})
    }
    if (window.innerWidth >= 576 && window.innerWidth < 1024) {
        $(".first-sec .info-block").css({"height": "" + (window.innerHeight * 0.4) + "px"});
    }

    /* Animation and Fullpage initialization */
    function aosInit() {
        AOS.init({
            duration: 900,
            once: true,
    ...
    function initAnimationAndScrolling() {
        // var browseWidth = document.documentElement.clientWidth;
        var browseWidth = window.innerWidth;
        var menuFpHeight = '100px';
        if (browseWidth < 1450) menuFpHeight = '90px';
        if (browseWidth >= 1200) {
            $('#fullpage').fullpage({
                anchors: ['first-sec', 'products-sec', 'about-sec', 'contact-sec'],
                controlArrows: true,
                verticalCentered: false,
                paddingTop: menuFpHeight,
                fixedElements: '.header, .small-menu-block',
            });
    ...
    if($('.mp-sect').length && $(window).outerHeight() >= 650) {
        initAnimationAndScrolling();
    } else {
    ...
    // Checking browser resize to enable or disable fullpage
    ...
    $(window).resize(function () {
        ...
        // console.log(currentWidth + ' - ' + innerWidth);
        if($('.mp-sect').length) {
            ...
            if (initialWidth >= 1450) {
                if (currentWidth < 1450) {
                    location.reload();
                }
            } else if (initialWidth < 1450) {
                if (currentWidth >= 1450) {
                    location.reload();
                }
            }
    ...
    /* End Animation and Fullpage initialization */

    /* fullPageAnimate */
    function fullPageAnimate() {
        $body = $("body");
        $bodyClass = $body.attr("class");
        if ($("div").is("#map") || $("div").is(".products-page-btn") && $bodyClass == 'fp-viewing-products-sec') { // if current page is 'Contacts' or 'Downloads,
            $("body").removeClass('fp-viewing-products-sec').addClass('fp-viewing-contact-sec');
            $bodyClass = 'fp-viewing-contact-sec';	// than second section is fp-viewing-contact-sec
        }
        $(".menu-list>li a").removeClass("active");

        switch ($bodyClass) {
            case 'fp-viewing-first-sec':
                $(".menu-list>li a.main-sec-link").addClass("active");
                break;
            case 'fp-viewing-products-sec':
                $(".product-block").addClass("aos-animate");
                $(".product-item").addClass("aos-animate");
                $(".menu-list>li a.products-sec-link").addClass("active");
                productsFlipping();
                break;
            case 'fp-viewing-about-sec':
                $(".about-block>div").addClass("aos-animate");
                $(".about-item").addClass("aos-animate");
                $(".about-img").addClass("aos-animate");
                $(".menu-list>li a.about-sec-link").addClass("active");
                break;
            case 'fp-viewing-contact-sec':
                $(".contact-block").addClass("aos-animate");
                $(".contact-item-title").addClass("aos-animate");
                $(".form-card").addClass("aos-animate");
                $(".menu-list>li a.contact-sec-link").addClass("active");
                break;
            // default:
            // 	console.log("There are no actions for class:" + $bodyClass);
        }
    }

    setTimeout(fullPageAnimate, 700);
    setTimeout(fullPageAnimate, 1100);
    setTimeout(fullPageAnimate, 1400);
    $(window).on('wheel', fullPageAnimate);
    $(".menu-list>li a, .products-sec-link").on('click', function (e) {
        if (innerWidth < 1200) {
            //e.preventDefault();

            $("ul.menu-list>li a").removeClass("active");
            $(this).addClass("active");

            var menuHeight = parseInt($(".header-row").css('height')) - 1;
            var el, anchor = $(this);
            if (anchor.attr('href') != '#') {
            ...
            setTimeout(fullPageAnimate, 300);
        }
    });
    /* End fullPageAnimate */
    ...
    /* Languages */
    /*
     $(".lang-block a").click(function(e){
     e.preventDefault();
     // make active current languge in block of languages
     $(".lang-block a").removeClass("active-lang");
     $(this).addClass("active-lang");
     //make active current languge in main menu
     var curLang = $(this).parent().attr('class');
     $(".lang>a").removeClass('active-li-lang');
     $(".lang>a."+curLang).addClass('active-li-lang');
     });
     */
    $(".lang, .lang-block").mouseover(function () {
        $(".lang").find('i').removeClass("fa-chevron-down").addClass("fa-chevron-up");
    }).mouseleave(function () {
        $(".lang").find('i').addClass("fa-chevron-down").removeClass("fa-chevron-up");
    });

    $(".small-lang").click(function (e) {
        //e.preventDefault();
    ...
    $(".product-item").click(function () {
        ...
        $(location).attr('href', url); // opens in current window
        //window.open(url); // opens in new window
    });

    // Text changes in products
    $(".product-item").mouseenter(function () {
        var item = $(this);

        $(".product-item-text").stop().fadeOut(200);
        setTimeout(function () {
            if (item.hasClass("steel")) {
                $(".product-item-text").stop().fadeOut(200);
                $(".product-item-text.steel").stop().fadeIn(200);
            }
            else if (item.hasClass("construction")) {
                $(".product-item-text").stop().fadeOut(200);
                $(".product-item-text.construction").stop().fadeIn(200);
            }
            else if (item.hasClass("machinery")) {
                $(".product-item-text").stop().fadeOut(200);
                $(".product-item-text.machinery").stop().fadeIn(200);
            }
            else if (item.hasClass("fertilizers")) {
                $(".product-item-text").stop().fadeOut(200);
                $(".product-item-text.fertilizers").stop().fadeIn(200)
            }
        }, 210);
    });
    $(".product-items").mouseleave(function () {
        $(".product-item-text").stop().fadeOut(200);
        setTimeout(function () {
            $(".product-item-text").stop().fadeOut(200);
            $(".product-item-text.steel").stop().fadeIn(200);
    ...
    //Item Color Show on Interval
    var i = 0; // iterations count
    var first = true;

    function productsFlipping() {
        if ($("body").hasClass('fp-viewing-products-sec') && first) {
            first = false;
            var interval = setInterval(function () {
                $(".product-item:nth-child(" + i + ")").css("filter", "grayscale(100%)").find("p").css("transform", "scale(1)").next().css("opacity", "0");
                $(".product-item-text").fadeOut(200);
                i++;
                if (i == 5) {
                    $(".product-item-text.steel").fadeIn(200);
                    clearInterval(interval);
                }
                $(".product-item:nth-child(" + i + ")").css("filter", "grayscale(0)").find("p").css("transform", "scale(1.05)").next().css("opacity", "1");
                $(".product-item-text:nth-child(" + (i + 1) + ")").fadeIn(200);
            }, 800);
        }
    }
    ...
    $(".hamburger").click(function () {
        ...
        $(".small-menu-block").fadeToggle();
    });
    $(".modal-block").click(function () {
        $(".small-menu-block").fadeOut();
        $(".hamburger").removeClass("is-active");
    });
    /* End Menu button for small devices */

    /* Smooth scrolling on <1200 */
    $(".small-menu-block ul>li a[href*='#']").on("click", function (e) {
        //e.preventDefault();

        $(".small-menu-block a").removeClass("active");
        $(this).addClass("active");
        $(".small-menu-block").fadeOut();
        $(".langs").slideUp();
        $(".small-lang").find('i').removeClass("fa-chevron-up").addClass("fa-chevron-down");
        $(".hamburger").removeClass("is-active");

        var menuHeight = parseInt($(".header-row").css('height')) - 1;
        var anchor = $(this);
        var el = (anchor.attr('href') != '#') && $(anchor.attr('href')); // if href hasn't just "#", write name of id
        if (el.length > 0) {
            $('html, body').stop().animate({
                scrollTop: (el.offset().top - menuHeight)
            }, 777);
    ...
    /* End Smooth scrolling on <1200 */

    /* Google Map */
    function initMap() {
        var myLatLng = {lat: 52.3932512, lng: 4.8351195};
        ...
        marker.setIcon("files/images/pin.svg");
    }
    ...
    /* Form */
    // Minimal Javascript (Forms for Edge, IE and select box)
    ...
    // For btn
    $(".form-btn, for-btn").click(function () {
        var menuHeight = parseInt($(".header-row").css('height')) - 1;
        $('html, body').animate({
            scrollTop: ($("#field-name").offset().top - menuHeight - 20)
        }, 777);
    });
    /* End Form */

    /* Products Page */
    $(".products-page-btn label").click(function () {
    ...
    //$(".contact-block p").dotdotdot();
    //$(".contacts-page-block").dotdotdot();
