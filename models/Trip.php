...
class Trip extends \yii\db\ActiveRecord
{
    ...
    public
    static function getQueue($cache = false)
    {
    ...
    public
    static function getTaxiStatusList()
    {
        return [
    ...
    public
    static function getAllRoutePoints()
    {
    ...
    public
    static function getVehicleTypeList()
    {
