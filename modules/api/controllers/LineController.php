...
class LineController extends BaseController
{
    ...
    public function actionOnLine($id)
    {
        ...
        if (!$vehicle) $this->module->setError(422, '_vehicle', "Not Found");

        /** @var \app\models\Checkpoint $startpoint */
        $startpoint = Checkpoint::findOne($this->body->startpoint);
        if (!$startpoint || $startpoint->type != $startpoint::TYPE_START) $this->module->setError(422, '_startpoint', "Not Found");

        /** @var \app\models\Checkpoint $endpoint */
        $endpoint = Checkpoint::findOne($this->body->endpoint);
        if (!$endpoint || $endpoint->type != $endpoint::TYPE_END) $this->module->setError(422, '_endpoint', "Not Found");
