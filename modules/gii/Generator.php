...
abstract class Generator extends Model
{
    ...
    public function hints()
    {
        return [
            ...
            'multiLang' => 'Check "Multi Lang" for enable multilang behavior. Type in input "Multi Lang Array" names of needed fields. Be Careful with name of fields and data(table _lang will overwrite).',
            'multiLangArray' => 'Check "Multi Lang" for enable multilang behavior. Type in input "Multi Lang Array" names of needed fields. Be Careful with name of fields and data(table _lang will overwrite).',
        ];
    }
