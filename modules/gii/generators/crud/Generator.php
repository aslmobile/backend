...
class Generator extends \app\modules\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['enableI18N', 'enablePjax', 'multiLang'], 'boolean'],
    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($column->phpType === 'boolean') {
            ...
            return "\$form->field(\$model, '$attribute')->widget(TTinyMCE::className(), [
                                'clientOptions' => [
        ...
        } elseif ($attribute == 'image' || $attribute == 'preview') {
            //} elseif ($column->type === 'varchar') {
            return "\$form->field(\$model, '$attribute')->widget(InputFile::className(), [
...
//            return "\$form->field(\$model, '$attribute')->textarea(['rows' => 6])";
     ...
     * @return string
     */
    public function generateMlActiveField($attribute)
    {
        $tableSchema = $this->getTableSchema();
        if ($tableSchema === false || !isset($tableSchema->columns[$attribute])) {
            if (preg_match('/^(password|pass|passwd|passcode)$/i', $attribute)) {
     ...
     * @return array model column names
     */
    public function getMlColumnNames()
    {

        /* @var $class ActiveRecord */
        $class = $this->modelClass . 'Lang';
        if (is_subclass_of($class, 'yii\db\ActiveRecord')) {
            return $class::getTableSchema()->getColumnNames();
        } else {
            /* @var $model \yii\base\Model */
