        ...
        <div class="row">
            <div class="col-md-8 col-xs-12">
                <div class="box box-widget">
                    <a href="<?= \yii\helpers\Url::to('/admin/vehicles') ?>">
                        <div class="box-header with-border text-uppercase bg-aqua"><i
                                    class="fa fa-car"></i><strong><?= Yii::t('app', "Автомобили"); ?></strong></div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-4 border-right">
                                    <div class="description-block">
                                        <h5 class="description-header"
                                            style="font-size: 32px;"><?= \app\models\Vehicles::find()->count(); ?></h5>
                                ...
                                <div class="col-sm-4 border-right">
                                    <div class="description-block">
                                        <h5 class="description-header"
                                            style="font-size: 32px;"><?= \app\models\Vehicles::find()->where(['status' => [\app\models\Vehicles::STATUS_WAITING, \app\models\Vehicles::STATUS_ADDED]])->count(); ?></h5>
                                ...
                                <div class="col-sm-4">
                                    <div class="description-block">
                                        <h5 class="description-header"
                                            style="font-size: 32px;"><?= \app\models\Vehicles::find()->where(['status' => \app\models\Vehicles::STATUS_APPROVED])->count(); ?></h5>
                                ...
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <?php switch ($vehicle->status) {
                                            case $vehicle::STATUS_WAITING:
                                                $vsc = 'orange';
                                                break;
                                            case $vehicle::STATUS_APPROVED:
                                                $vsc = 'green-active';
                                                break;
                                            case $vehicle::STATUS_ADDED:
                                                $vsc = 'aqua-active';
                                                break;
                                        ...
                                        <span class="product-description">
                                            <span class="badge no-border"
                                                  style="border-radius: 0;"><?= $vehicle->license_plate; ?></span>
                                            <span class="badge bg-aqua"
                                                  style="border-radius: 0;"><?= $vehicle->vehicleName; ?></span>
                                        </span>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                    ...
                    <div class="box-footer text-center bg-gray-light">
                        <a href="<?= \yii\helpers\Url::toRoute('/admin/vehicles/index/'); ?>"
                           class="uppercase"><?= Yii::t('app', "Список всех автомобилей"); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="box box-widget">
                    <a href="<?= \yii\helpers\Url::to('/admin/user/drivers') ?>">
                        <div class="box-header with-border text-uppercase bg-aqua"><i
                                    class="fa fa-users"></i><strong><?= Yii::t('app', "Водители"); ?></strong></div>
                            ...
                            foreach ($users as $user) : ?>
                                <li>
                                    ...
                                    <a class="users-list-name"
                                       href="<?= \yii\helpers\Url::toRoute('/admin/user/view/' . $user->id); ?>"><?= $user->fullName; ?></a>
                ...
                <div class="box-footer text-center bg-gray-light">
                    <a href="<?= \yii\helpers\Url::toRoute('/admin/user/drivers/'); ?>"
                       class="uppercase"><?= Yii::t('app', "Список всех водителей"); ?></a>
                </div>
            </div>

            <div class="box box-widget">
                <a href="<?= \yii\helpers\Url::to('/admin/user/passengers') ?>">
                    <div class="box-header with-border text-uppercase bg-aqua"><i
                                class="fa fa-users"></i><strong><?= Yii::t('app', "Пассажиры"); ?></strong></div>
                    <div class="box-body no-padding">
                </a>
            ...
            <div class="box-footer text-center bg-gray-light">
                <a href="<?= \yii\helpers\Url::toRoute('/admin/user/passengers/'); ?>"
                   class="uppercase"><?= Yii::t('app', "Список всех пассажиров"); ?></a>
            </div>
        </div>
    </div>
</div>
