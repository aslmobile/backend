    ...
    <section class="content">
        <div class="row">
                            ...
                            'attributes' => [
                                [
                                    ...
                                    'value' => function ($model) {
                                        return $model->user ? $model->user->fullName : Yii::t('app', "Удален");
                                    }
                                ],
                                [
                                    'attribute' => 'user_id',
                                    ...
                                    'value' => function ($model) {
                                        $phone = $model->user ? $model->user->phone : 380000000000;
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="box box-widget">
                    <div class="box-header bg-yellow with-border"><i
                                class="fa fa-taxi"></i> <?= Yii::t('app', "Информация о такси"); ?></div>
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                foreach ($luggages as $luggage) : ?>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="box-header bg-info"><?= Yii::t('app', "Багаж"); ?>
                                            №<?= $luggage->id; ?></div>
                                        <?= DetailView::widget([
                                            'model' => $luggage,
                                            'attributes' => [
