...
$created_at =(!empty(Yii::$app->request->get('ProductsSearch')['created_at'])) ? Yii::$app->request->get('ProductsSearch')['created_at'] : null;
?>
...
//                    ],
                    ...
                    'created_at' => [
                            ...
                            'filter' => DatePicker::widget([
                                    'name' => 'ProductsSearch[created_at]',
                                    'value' => $created_at,
