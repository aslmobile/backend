...
$this->title = Yii::$app->mv->gt('Страницы',[],false);
                    ...
                    <?= Html::a(
                        ...
                        [
                            ...
                            'onclick'=>"
								...
								if (keys!='') {
									if (confirm('".Yii::$app->mv->gt('Вы действительно хотите удалить выбранное?',[],false)."')) {
										$.ajax({
											type : 'POST',
											data: {keys : keys},
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    /*[
                        ...
                        'format' => 'html',
                        'value' => function($data) {
                            return Yii::$app->imageCache->img($_SERVER['DOCUMENT_ROOT'].$data->image,'100x100', ['class'=>'img-circle width-1']);
                        },
                    ],*/
                    [
                        'attribute' => 'title',
                    ...
                    [
                        ...
                        'content' => function ($model) {
                            return Html::a($model->url,['/main/default/index', 'link' => $model->url],['target'=>'_blank']);
                        },
                    ],
                    'created_at:datetime',
                    [
