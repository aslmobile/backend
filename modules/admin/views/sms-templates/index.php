...
/* @var $searchModel app\modules\admin\models\SmsTemplatesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', "Шаблоны СМС");
        ...
        <div class="box box-primary">
            ...
            <?= GridView::widget([
                ...
                'rowOptions' => function ($model, $key, $index, $grid) {
                    return [
                        'role' => 'button',
                        'onclick' => "window.location = '" . \yii\helpers\Url::toRoute("/admin/sms-templates/view/" . $key) . "'"
                    ];
                },
                'layout'=>"
